...
export default class Report extends React.Component {
                        ...
                        <div className="field">
                            ...
                            <div className="control">
                                <input
                                    className="input"
                                    type="text"
                                    placeholder="e.g Ghanaian Language Translator (GLT)"
                        ...
                        <div className="field">
                            ...
                            <div className="control">
                                <input
                                    className="input"
                                    type="text"
                                    placeholder="e.g. Henry Nunoo-Mensah"
    ...
    add_title(doc) {
        ...
        doc.text("FACETS Responsible A.I. Report", 15, 25);
    }
    ...
    create() {
        ...
        doc.save("FACETS-Responsible-AI-Report-" + timestamp + ".pdf");
